...
func (s *BaseLuaListener) EnterVar_(ctx *Var_Context) {}

// ExitVar_ is called when production var_ is exited.
func (s *BaseLuaListener) ExitVar_(ctx *Var_Context) {}
...
func (s *BaseLuaListener) EnterStringg(ctx *StringgContext) {}

// ExitStringg is called when production stringg is exited.
func (s *BaseLuaListener) ExitStringg(ctx *StringgContext) {}
