...
type LuaListener interface {
	...
	// EnterStringg is called when entering the stringg production.
	EnterStringg(c *StringgContext)
	...
	// ExitStringg is called when exiting the stringg production.
	ExitStringg(c *StringgContext)
}
